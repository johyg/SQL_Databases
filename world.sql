...
*/
#VG-del för inlämning 1 SQL och databaser
DROP TABLE IF EXISTS `englishlanguage`;

#Skapa en ny tabell
CREATE TABLE `englishlanguage` (
  `CountryAbbreviation` char(3) NOT NULL DEFAULT '',
  `MainLanguage` char(30) NOT NULL DEFAULT '',
  `CountryName` VARCHAR(20) NOT NULL DEFAULT '',
  PRIMARY KEY (`CountryAbbreviation`,`MainLanguage`),
  CONSTRAINT `englishlanguage_ibfk_2` FOREIGN KEY (`CountryAbbreviation`) REFERENCES `countrylanguage` (`CountryCode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

#Lägg in data i tabellen

INSERT INTO `englishlanguage` VALUES ('ABW','Dutch','Aruba');
INSERT INTO `englishlanguage` VALUES ('AFG','Dari','Afghanistan');
INSERT INTO `englishlanguage` VALUES ('AIA','English','Anguilla');
INSERT INTO `englishlanguage` VALUES ('ALB','Albanianan','Albania');
INSERT INTO `englishlanguage` VALUES ('BEL','French','Belgium');
INSERT INTO `englishlanguage` VALUES ('DNK','Danish','Denmark');
INSERT INTO `englishlanguage` VALUES ('IND','Hindi','India');
INSERT INTO `englishlanguage` VALUES ('IRN','Persian','Iran');
INSERT INTO `englishlanguage` VALUES ('GEO','Georgiana','Georgia');
INSERT INTO `englishlanguage` VALUES ('MAC','Portuguese','Macao');
INSERT INTO `englishlanguage` VALUES ('NZL','English','New Zealand');
INSERT INTO `englishlanguage` VALUES ('UKR','Ukrainian','Ukraine');
commit;